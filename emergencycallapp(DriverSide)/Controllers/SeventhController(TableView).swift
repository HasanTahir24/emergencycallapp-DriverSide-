//
//  SeventhController(TableView).swift
...
class SeventhController_TableView_: UITableViewController {
    var textarray=["Home","History","Log Out"]
    var picarray=["house-outline","clipboard","left-arrow (1)"]
...
tableView.reloadData()
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row==1{
          //  self.performSegue(withIdentifier: "history", sender: nil)
            ...
            let storyboard = UIStoryboard(name: "Main", bundle: nil)
            let viewController = storyboard.instantiateViewController(withIdentifier :"first screen") as! EleventhController_First_Screen_
            self.present(viewController, animated: true)
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.picture.image=UIImage(named:  picarray[indexPath.row])
